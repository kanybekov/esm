	...
	1. О программе:
"Система распределения вычислительных заданий в Web"

	Авторы: студенты группы ЕТ-223
Бобыкин Даниил
Гриценко Павел
Даутов Рустам
Каныбеков Ансар
...
Здесь 2 - количество данных
12, 11 - собственно данные
alpha 0.2 - значение коэффициента alpha

2) Выберите соответствующую задачу из списка;
3) Нажмите кнопку "Загрузить".

В случае успеха вы увидите сообщение о том, что файл загружен. Далее будет производится вычисление, по окончании которого вы увидите информационное окно. Для продолжения нажмите "ОК".
Результат вычисления можно посмотреть на странице результатов.
